...
const ProjectDetails = ({
  ...
  return (
    <Card className="mx-auto flex w-full max-w-6xl flex-col md:w-2/3 md:flex-row">
      {/* Image */}
      {previewImage && url && (
        <div
          className={mergeClasses(
            "flex items-center justify-center border-gray-100 bg-gray-50 p-8 dark:bg-gray-200 max-md:rounded-t-xl",
            !previewImage ? "w-full" : "md:w-1/2",
            layoutType === "default"
      ...
      <div
        className={mergeClasses(
          "flex flex-col gap-6 p-8 lg:p-12",
